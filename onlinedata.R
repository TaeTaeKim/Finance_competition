...
online <- online[, c("품목대분류명", "성별", "연령", "매출금액","거리두기")]
#고객소재지_시군구 제외함
...
fit_lasso <- cv.glmnet(online_x, online_y, family = "gaussian")
fit_ridge <- cv.glmnet(online_x, online_y, family = "gaussian", alpha = 0)
